  ...
  return (
    <div className="my-10 flex flex-col mx-80 gap-y-5 w-fit items-center border-b-gray-500">
      ...
      <img
        ...
        className="w-[60%] aspect-video rounded-md cursor-pointer selection:bg-emerald-700"
      />
      ...
      <div className="flex w-[58%] flex-col gap-y-1">
        <p className="line-clamp-1 text-sm">
          <strong className="font-medium">John Cena</strong>: Lorem ipsum dolor
          sit amet, consectetur adipiscing elit. Aenean mi ante, tristique
        </p>
        <p className="line-clamp-1 text-sm">
          <strong className="font-medium">John Cena</strong>: Lorem ipsum dolor
          sit amet, consectetur adipiscing elit. Aenean mi ante, tristique
        </p>
        <button className="h-3 w-fit text-gray-500 text-sm">
          View all comments
        </button>
      </div>
    </div>
